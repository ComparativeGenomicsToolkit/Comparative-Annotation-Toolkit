...
setup(
    ...
    scripts=[
        "programs/cat_to_ncbi_submit",
        "programs/translate_gene_pred",
        "programs/validate_gff3",
        "programs/cat_parse_ncbi_genbank",
        "programs/cat_parse_ncbi_refseq",
        "programs/cat_parse_prokka_gff3",
