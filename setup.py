...
setup(
    ...
    scripts=['programs/cat_to_ncbi_submit', 'programs/translate_gene_pred',
             ...
             'programs/convert_ncbi_gff3', 'programs/convert_cupcake_gff',
             'programs/convert_ncbi_refseq_genbank_chromosomes',
             'programs/convert_ncbi_refseq_genbank_chromosomes_hal'],
    author='Ian Fiddes',
